...
/* Sun type 5 keyboard, US IBM-style
,-------.  ,---,  ,---------------. ,---------------. ,---------------.   ,-----------. ,---------------.
...
#endif
{
    ...
    STOP,   FN4,     GRV,1,  2,  3,  4,  5,  6,  7,  8,  9,  0,   MINS,EQL,      BSPC,  INS, HOME,PGUP,  NLCK,PSLS,PAST,PMNS,
    MENU,   FN3,     TAB, Q,  W,  E,  R,  T,  Y,  U,  I,  O,  P,   LBRC,RBRC,    BSLS,  DEL, END, PGDN,  P7,  P8, P9,  PPLS,
